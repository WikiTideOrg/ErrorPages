		...
		<html lang="en">
			...
			<div class="container">
				...
				<div class="jumbotron">
					...
					<p>
						<a href="https://meta.wikiforge.net/wiki/Special:RequestPremiumWiki?wpsubdomain={$subdomain}.wikiforge.net" class="btn btn-lg btn-outline-primary" role="button">Request the Wiki</a>
					</p>
				</div>
			</div>
